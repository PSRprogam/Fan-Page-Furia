        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <img src="https://upload.wikimedia.org/wikipedia/pt/thumb/f/f9/Furia_Esports_logo.png/250px-Furia_Esports_logo.png" alt="FURIA" className="h-10 w-auto" />
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/FURIA" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-furia-purple transition-colors">
              ...
              <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-furia-purple transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400 hover:text-furia-purple transition-colors"><a href="#home">Home</a></li>
              <li className="text-gray-400 hover:text-furia-purple transition-colors"><a href="#team">Team</a></li>
              <li className="text-gray-400 hover:text-furia-purple transition-colors"><a href="#matches">Matches</a></li>
              <li><Link to="/history" className="text-gray-400 hover:text-furia-purple transition-colors">History</Link></li>
              <li className="text-gray-400 hover:text-furia-purple transition-colors"><a href="#quiz">Quiz</a></li>
            </ul>
          </div>
